...
namespace DarkMultiPlayerServer
{
    public class Dekessler
    {
        ...
        public static void CheckTimer()
        {
            ...
            if (Server.serverSettings.Settings.autoDekessler > 0)
            {
                //Run it on server start or if the nuke time has elapsed.
                if (((Server.serverClock.ElapsedMilliseconds - lastDekesslerTime) > (Server.serverSettings.Settings.autoDekessler * 60 * 1000)) || lastDekesslerTime == 0)
                {
