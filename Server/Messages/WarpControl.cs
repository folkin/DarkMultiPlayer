...
namespace DarkMultiPlayerServer.Messages
{
    public class WarpControl
    {
        ...
        {
            if (!Server.serverSettings.Settings.keepTickingWhileOffline && ClientHandler.GetClients().Length == 1)
            {
            ...
            if (Server.serverSettings.Settings.sendPlayerToLatestSubspace || !playerSubspace.ContainsKey(client.playerName))
            {
